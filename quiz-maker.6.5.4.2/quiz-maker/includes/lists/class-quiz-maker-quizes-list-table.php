...
class Quizes_List_Table extends WP_List_Table{
    ...
    public function add_or_edit_quizes(){
        ...
        if( isset($_POST["quiz_action"]) && wp_verify_nonce( sanitize_text_field( $_POST["quiz_action"] ), 'quiz_action' ) ){
            ...
            $quiz_admin_note_text_transform = (isset($_REQUEST['ays_quiz_admin_note_text_transform']) && $_REQUEST['ays_quiz_admin_note_text_transform'] != '') ? stripslashes( esc_attr( $_REQUEST['ays_quiz_admin_note_text_transform'] ) ) : 'none';

...
function gamipress_bp_settings_meta_boxes( $meta_boxes ) {
    ...
    $meta_boxes['gamipress-bp-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_bp_settings_fields', array(
            ...
            $prefix . 'members_points_types_hide' => array(
                'name' => __( 'Hide If No Earnings', 'gamipress' ),
                'desc' => __( 'Hide the points types where user has not earned anything. Applied to users with a balance of 0 points.', 'gamipress' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'members_ranks_types_hide' => array(
                'name' => __( 'Hide If No Earnings', 'gamipress' ),
                'desc' => __( 'Hide the rank types where user has not earned anything. Applied to users in the default rank.', 'gamipress' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
        ...
        'tabs' => apply_filters( 'gamipress_bp_settings_tabs', array(
            'points' => array(
                ...
                'fields' => array(
                    ...
                    $prefix . 'members_points_types_hide',
            ...
            'ranks' => array(
                ...
                'fields' => array(
                    ...
                    $prefix . 'members_ranks_types_hide',
    ...
    $meta_boxes['gamipress-bp-tab-settings'] = array(
        'title' => __( 'BuddyBoss Profile Tab', 'gamipress' ),
        'fields' => apply_filters( 'gamipress_bp_tab_settings_fields', array_merge( array(
            ...
            $prefix . 'points_tab_title' => array(
                ...
                'desc' => __( 'Text to show on the BuddyBoss user profile.', 'gamipress' ),
                'type' => 'text',
            ...
            $prefix . 'tab_points_types' => array(
                'name' => __( 'Points Types', 'gamipress' ),
                'desc' => __( 'Choose the points types you want to show on BuddyBoss user profile.', 'gamipress' )
            ...
            $prefix . 'tab_points_types_hide' => array(
                'name' => __( 'Hide If No Earnings', 'gamipress' ),
                'desc' => __( 'Hide the points types where user has not earned anything. Applied to users with a balance of 0 points.', 'gamipress' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ...
            $prefix . 'tab_achievements_types' => array(
                ...
                'desc' => __( 'Choose the achievement types you want to show on BuddyBoss user profile achievements tab.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress' ),
                'type' => 'multicheck',
            ...
            $prefix . 'members_achievements_template_title' => array(
                ...
                'description' => __( 'Setup how achievements should look on the BuddyBoss user profile tab.', 'gamipress' ),
                'type'        => 'title',
            ),
            ...
            $prefix . 'tab_ranks_types' => array(
                'name' => __( 'Rank Types', 'gamipress' ),
                'desc' => __( 'Choose the rank types you want to show on BuddyBoss user profile ranks tab.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_bp_tab_ranks_types_option_cb',
            ),
            $prefix . 'tab_ranks_types_hide' => array(
                'name' => __( 'Hide If No Earnings', 'gamipress' ),
                'desc' => __( 'Hide the rank types where user has not earned anything. Applied to users in the default rank.', 'gamipress' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ...
            $prefix . 'members_ranks_template_title' => array(
                ...
                'description' => __( 'Setup how ranks should look on the BuddyBoss user profile tab.', 'gamipress' ),
                'type'        => 'title',
            ),
...
function gamipress_bp_block_users_settings_meta_boxes( $meta_boxes ) {
    ...
    $meta_boxes['gamipress-bp-block-users-settings'] = array(
        'title' => __( 'BuddyBoss Block Users', 'gamipress' ),
...
function gamipress_bp_points_types_option_cb( $key = '' ) {
	...
	$points_types_order = isset( $gamipress_settings[$key] ) ?
        $gamipress_settings[$key] : $points_types_slugs;

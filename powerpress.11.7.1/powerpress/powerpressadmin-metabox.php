    ...
    <div id="chapters-<?php echo $FeedSlug; ?>" class="pp-tabcontent">
        <div class="pp-section-container">
            ...
            <div id="chapters-box-options-<?php echo $FeedSlug; ?>" style="margin-top: 1.5em;<?php echo $chapters_box_style; ?>">
                ...
                <div class="powerpress_row" id="powerpress_pci_chapters_container_<?php echo $FeedSlug; ?>" <?php if (empty($PCIChapters) || !empty($PCIChaptersManual)) { echo "style=\"display: none;\""; } ?>>
                    <div class="powerpress_row_content">
...
function print_table_body_vts($timeSplit, $FeedSlug, $vts_id, $post_id) {
    ...
    $title = $timeSplit['recipient'] == 1 ? 'Value Recipient(s)' : $timeSplit['remote_item']['item_title'];
    ...
    $html .= "<div class='row card-body'>";
    $html .= "<div class='col d-flex align-items-center' style='width: 100px;'><div class='time-container'><input required pattern='([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1})' style='width: 100%;' name='Powerpress[$FeedSlug][vts][$vts_id][start_time]' class='time-input' type='text' value='$startTime' /></div></div>";
    $html .= "<div class='col d-flex align-items-center' style='width: 100px;'><div class='time-container'><input required pattern='([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1}):([0-9]{2}|[0-9]{1})' style='width: 100%;' name='Powerpress[$FeedSlug][vts][$vts_id][duration]' class='time-input' type='text' value='$duration' /></div></div>";

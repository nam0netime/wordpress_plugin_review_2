...
class Wp_Ai_Content_Generator_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        if(strpos($screen->id, 'wpaicg') !== false) {
            ...
            // wpaicg or wpaicg_single_content_beta
            if (isset($_GET['page']) && $_GET['page'] == 'wpaicg' || isset($_GET['page']) && $_GET['page'] == 'wpaicg_single_content') {
                wp_enqueue_style(
                    'clean-formfull',
            ...
            //or wpaicg_single_content_beta
            if (isset($_GET['page']) && $_GET['page'] == 'wpaicg_chatgpt' || isset($_GET['page']) && $_GET['page'] == 'wpaicg' || isset($_GET['page']) && $_GET['page'] == 'wpaicg_single_content') {
                wp_enqueue_style(
                    'clean-form',

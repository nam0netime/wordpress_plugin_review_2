...
<div class="wpaicg-alert">
    ...
    if(!empty($wpaicg_cron_job_last_time)):
        ...
        ?>
        <p><?php echo sprintf(esc_html__('The last time, the Cron Job ran on your website %s (%s ago)','gpt3-ai-content-generator'),gmdate('Y-m-d H:i:s',$wpaicg_cron_job_last_time),$wpaicg_output)?></p>
    <?php
    endif;
    ?>
    <hr>
